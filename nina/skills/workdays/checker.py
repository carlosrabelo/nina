...
def get_context(
    ...
    at_work = presence.status in (PresenceStatus.WORK, PresenceStatus.HOME)
    ...
    # Only WORK on a weekend is "weekend work" — HOME on a weekend is just off hours
    weekend_work = presence.status == PresenceStatus.WORK and is_weekend
    ...
    elif presence.status == PresenceStatus.WORK and is_work_time:
