...
_KEYWORDS: dict[str, set[str]] = {
    "pt": {"home", "casa", "escritório", "escritorio", "saindo", "saí", "sai",
           ...
           "no trabalho", "home office", "presencial", "campus"},
...
- work: at the office, at the campus, at client site, arrived at work (any in-person work location)
...
- "status": one of "home", "work", "out", "dnd" (only when action is "set_presence")
- "note": a brief note extracted from the message, in the same language as the input (can be empty string)

Return ONLY valid JSON, no explanation, no markdown.

Examples:
"Acabei de chegar no trabalho" -> {"action": "set_presence", "status": "work", "note": ""}
"Cheguei no campus" -> {"action": "set_presence", "status": "work", "note": "campus"}
"Estou no cliente" -> {"action": "set_presence", "status": "work", "note": "cliente"}
...
"Just got to the office" -> {"action": "set_presence", "status": "work", "note": ""}
"At the campus" -> {"action": "set_presence", "status": "work", "note": "campus"}
