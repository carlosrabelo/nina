...
Schema: {"action": "list|teach|dismiss|none", "target_id": "<suggestion id prefix or empty>", "label_name": "<label string or empty>"}
Actions:
  list    — show open email suggestions
  dismiss — ignore an email suggestion
  teach   — teach/save a label for an email suggestion
...
- label_name: the name of the label they want to assign. Usually starts with "@" or a capital letter (e.g., "@Fornecedores", "Trabalho"). Do not include the word "label" or "etiqueta" in the label name itself.
