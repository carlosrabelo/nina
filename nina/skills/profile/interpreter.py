...
from nina.skills.profile.models import Profile
...
Presence statuses: home, work, out, dnd.
...
- "updates": list of objects, each with:
  - "presence": one of "home", "work", "out", "dnd"
...
-> {"action": "update_profile", "updates": [{"presence": "work", "gmail": ["work@empresa.com"], "calendar": []}]}
...
"work: work@co.com, home: me@gmail.com"
-> {"action": "update_profile", "updates": [
     {"presence": "work", "gmail": ["work@co.com"], "calendar": []},
...
def apply(intent: ProfileIntent, profile: Profile) -> Profile:
    ...
    from nina.skills.profile.models import PresenceProfile
