...
from nina.core.locale.store import load as load_locale, save as save_locale
...
async def handle_presence(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> None:
    from nina.skills.presence.models import PresenceStatus, PresenceState
...
async def handle_schedule(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    from nina.skills.calendar.blocking import execute as execute_blocking, BlockingIntent
