...
Ensinar ou listar etiquetas pendentes no **Telegram** (`/emailtag`) ou no **`nina console`** (`emailtag` ou `/emailtag`; ver `help` / `help emailtag` no console). Requer o scope OAuth `gmail.modify`.
